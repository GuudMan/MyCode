...
# -*- coding:utf-8 -*-
# ==============================
# @project ->File  :DemoTorch->models
# @Time      :2022/10/2 16:59
# @Author    :Peng neng
# @File      :models.py
# ===============================
import torch
...
from datasets_translation import MAX_LEN
...
class EncoderNN(nn.Module):
    def __init__(self, input_size, hidden_size):
        ...
        self.embdeeing = nn.Embedding(input_size, hidden_size)
        self.gru = nn.GRU(hidden_size, hidden_size)

    def forward(self, input, hidden):
        embedded = self.embdeeing(input).view(1, 1, -1)
        output = embedded
...
class AttenDecoderRNN(nn.Module):
    def __init__(self, hidden_size, output_size, dropout_p=0.1, max_len=MAX_LEN):
...
if __name__ == '__main__':
    encoder_net = EncoderNN(5000, 256)
